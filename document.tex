...
\section{Types of GPS-enabled games }
...
ARIS, Tourality, Wherigo, GhostEsc., conTAGion, Shadow Cities, SCVNGR, Please
Stay Calm, Parallel Mafia, Parallel Kingdom, Tripventure, Warfinger, Tidy City,
Portal Hunt, aMazing.
\newline

By their scope, we will classify the games in the following categories:

\begin{enumerate}
	\item \textbf{Tour Games} - This type of game has been evolved from geocaching
	games. They are the first GPS games to make it onto smartphones. They are
	mostly single player. The user follows a set of checkpoints set on a map in
	order to find a geocache or perform a tour of various interesting sites.
	Options include information about the sites (text, images, videos), quizzes
	etc.
	
	\item \textbf{Race Games} - This type of game was the first to be
	researched upon for multiplayer use. The first iterations appeared on the
	non-ubiquitous PDAs. Recently, a game named 'Tourality' was developed. The
	games supported are the mobile implementation of outdoor single and multiplayer
	games such as racing, trail hiking and rogaining. 
	
	\item \textbf{Battle Games} - there is only one attempt at this game type:
	'Warfinger'. The game was not yet released, although there are a website and a
	video presenting the concept.
	
	\item \textbf{Educational and Puzzle/Adventure Games} - There is a wider range
	of games developed under this category. The best known are Mentira and Dow Day
	(both authored with the ARIS platform), Inspector Tripton and Mission Mauerfall
	(both developed by Tripventure) and Mad City Mystery.
	
\end{enumerate}

\section{The Battle Games}

The Battle Games are GPS-enabled augmented reality games for single
player or multiplayer competitive free for all and team versus team games where
virtual tools are used for enhancing the gameplay. The Battle Games as a
category of games offers opportunities to also enhance the experience for all
