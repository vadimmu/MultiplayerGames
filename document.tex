...
\begin{enumerate}
  ...
  obvious. A logo has been attempted is the entry point of the the application
  (it is the fragment loaded by the Activity after it is created). It features four buttons: 'Connect to server', 'Info and Tutorials', 'Settings' and 'Exit'. By pressing 'connect to server', the player attempts to join the game. If the
  connection is successful, he is brought into the 'Lobby'. 'Info and
