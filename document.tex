...
We will now classify the games/platforms based on their characteristics:
...
\begin{enumerate}
  ...
  free-for-all play, the number of teams equals the number of players)  
...
As it is not the focus of this project, the Authoring Tool will comprise of the
most basic elements necessary for setting up the game(such as defining
obstacles and probably the border of the gameplay area).\newline
